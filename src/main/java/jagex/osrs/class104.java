...
public class class104 {
        ...
        if (var2 != var1) {
            ...
            for (int var7 = 0; var7 < var1; ++var7) {
                ...
                for (double var13 = (double) var2 / (double) var1; var11 < var12; ++var11) {
                    ...
                    var17 *=
                        0.54D + 0.46D * Math.cos(0.2243994752564138D * ((double) var11 - var9));
    ...
    byte[] method2452(byte[] var1, byte var2) {
        if (this.field1413 != null) {
            int var3 =
                (int) ((long) var1.length * (long) this.field1411 / (long) this.field1412) + 14;
            ...
            for (var7 = 0; var7 < var1.length; ++var7) {
                ...
                var6 += this.field1411;
                var10 = var6 / this.field1412;
                var5 += var10;
                var6 -= var10 * this.field1412;
            }
    ...
    int method2457(int var1, int var2) {
        if (this.field1413 != null) {
    ...
    int method2453(int var1, int var2) {
        if (this.field1413 != null) {
