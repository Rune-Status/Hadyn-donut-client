    ...
    static int method5073(int var0, class86 var1, boolean var2, int var3) {
        if (var0 == 5000) {
            ...
            class274.field3613 = class51
                .method1060(class70.field1070[class60.field600 + 1], -897441396);
            ...
            if (var0 == 5002) {
                ...
                if (var0 == 5003) {
                    ...
                    if (var16 != null) {
                        class70.field1070[++class60.field600 - 1] = var16.field595;
                    ...
                    if (var17 != null) {
                        class70.field1070[++class60.field600 - 1] = var17.field597;
                        class70.field1070[++class60.field600 - 1] = var17.field589;
                        class70.field1065[++class70.field1072 - 1] =
                    ...
                    class70.field1072 -= 2;
                    var4 = class70.field1065[class70.field1072];
                    String var13 = class70.field1065[class70.field1072 + 1];
                    ...
                    if (var0 == 5016) {
                        ...
                        var11 = class70.field1070[--class60.field600];
                        class70.field1070[++class60.field600 - 1] = class85
                            .method2148(var11, -1475978689);
                        return 1;
                    } else if (var0 == 5018) {
                        var11 = class70.field1070[--class60.field600];
                        class70.field1070[++class60.field600 - 1] = class32
                            .method606(var11, -1545928521);
                        return 1;
                    } else if (var0 == 5019) {
                        var11 = class70.field1070[--class60.field600];
                        class70.field1070[++class60.field600 - 1] = class57
                        ...
                        client.field862 = class70.field1065[--class70.field1072].toLowerCase()
                                                                                .trim();
                        return 1;
                    } else if (var0 == 5022) {
