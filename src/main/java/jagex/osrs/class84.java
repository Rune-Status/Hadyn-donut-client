...
public class class84 {
    ...
    void method2096(int var1) {
        ...
        this.field1241 = false;
        this.field1245 = Time.currentTimeMillis();
    }
    ...
    void method2090(int var1) {
        if (this.field1241 && this.field1245 < Time.currentTimeMillis() - 60000L) {
