...
public class class292 extends class287 {
    ...
    static int method5695(int var0, class86 var1, boolean var2, int var3) {
        ...
        if (var0 >= 2000) {
            var0 -= 1000;
            var5 = class18.method213(class70.field1070[--class60.field600], -1480946647);
            var4 = false;
        } else {
        ...
        int var12;
        if (var0 == 1300) {
            var12 = class70.field1070[--class60.field600] - 1;
            if (var12 >= 0 && var12 <= 9) {
                var5.method4711(var12, class70.field1065[--class70.field1072], (byte) 32);
                return 1;
            } else {
                --class70.field1072;
                return 1;
            ...
            if (var0 == 1301) {
                class60.field600 -= 2;
                var12 = class70.field1070[class60.field600];
                var7 = class70.field1070[class60.field600 + 1];
                var5.field2748 = class9.method102(var12, var7, 639929772);
                return 1;
            } else if (var0 == 1302) {
                var5.field2784 = class70.field1070[--class60.field600] == 1;
                return 1;
            } else if (var0 == 1303) {
                var5.field2749 = class70.field1070[--class60.field600];
                return 1;
            } else if (var0 == 1304) {
                var5.field2799 = class70.field1070[--class60.field600];
                return 1;
            } else if (var0 == 1305) {
                var5.field2697 = class70.field1065[--class70.field1072];
                return 1;
            } else if (var0 == 1306) {
                var5.field2752 = class70.field1065[--class70.field1072];
                return 1;
            } else if (var0 == 1307) {
                var5.field2731 = null;
                return 1;
                ...
                if (var0 != 1350) {
                    ...
                    if (var0 == 1351) {
                        class60.field600 -= 2;
                        var6 = 10;
                        var10 = new byte[]{(byte) class70.field1070[class60.field600]};
                        byte[] var11 = new byte[]{(byte) class70.field1070[class60.field600 + 1]};
                        ...
                        var12 = class70.field1070[class60.field600] - 1;
                        var7 = class70.field1070[class60.field600 + 1];
                        var8 = class70.field1070[class60.field600 + 2];
                        if (var12 >= 0 && var12 <= 9) {
                    ...
                    if (var4) {
                        ...
                        for (var8 = 0; var8 < 10 && class70.field1070[var8 + class60.field600] >= 0;
                             var8 += 2) {
                            ;
                        }
                        ...
                        if (var8 > 0) {
                            ...
                            for (var8 -= 2; var8 >= 0; var8 -= 2) {
                                var9[var8 / 2] = (byte) class70.field1070[var8 + class60.field600];
                                var10[var8 / 2] = (byte) class70.field1070[var8 + class60.field600
                                    + 1];
                            }
                        }
                    } else {
                        ...
                        var10 = new byte[]{(byte) class70.field1070[class60.field600 + 1]};
                    }
    ...
    public void method5693(Buffer var1, int var2, byte var3) {
        while (true) {
            if (var1.offset < var2) {
                ...
                class293 var5 = new class293(var1.method3778(-13371226), this.field3716);
                class293 var6 = new class293(var1.method3778(-1817201014), this.field3716);
                ...
                if (var7 > 0) {
                    var1.method3778(773055666);
                    var1.getUByte();
                    var1.getInt();
                }

                var1.method3778(-712518370);
