    ...
    static int method1170(int var0, class86 var1, boolean var2, int var3) {
        ...
        if (var0 == 4200) {
            ...
            class70.field1065[++class70.field1072 - 1] = class84
                .method2125(var4, -205103429).field3515;
            return 1;
        } else {
            int var5;
            class271 var6;
            if (var0 == 4201) {
                field600 -= 2;
                var4 = class70.field1070[field600];
                var5 = class70.field1070[field600 + 1];
                var6 = class84.method2125(var4, -205103429);
                if (var5 >= 1 && var5 <= 5 && var6.field3526[var5 - 1] != null) {
                    class70.field1065[++class70.field1072 - 1] = var6.field3526[var5 - 1];
                } else {
                ...
                if (var5 >= 1 && var5 <= 5 && var6.field3541[var5 - 1] != null) {
                    class70.field1065[++class70.field1072 - 1] = var6.field3541[var5 - 1];
                } else {
                    class70.field1065[++class70.field1072 - 1] = "";
                }
                ...
                var4 = class70.field1070[--field600];
                class70.field1070[++field600 - 1] = class84.method2125(var4, -205103429).field3544;
                return 1;
            } else if (var0 == 4204) {
                var4 = class70.field1070[--field600];
                class70.field1070[++field600 - 1] =
                    class84.method2125(var4, -205103429).field3523 == 1 ? 1 : 0;
                return 1;
            } else {
                class271 var7;
                if (var0 == 4205) {
                    var4 = class70.field1070[--field600];
                    var7 = class84.method2125(var4, -205103429);
                    if (var7.field3552 == -1 && var7.field3549 >= 0) {
                        class70.field1070[++field600 - 1] = var7.field3549;
                    } else {
                        class70.field1070[++field600 - 1] = var4;
                    }
                    ...
                    var4 = class70.field1070[--field600];
                    class70.field1070[++field600 - 1] =
                        class84.method2125(var4, -205103429).field3512 ? 1 : 0;
                    return 1;
                } else if (var0 == 4208) {
                    var4 = class70.field1070[--field600];
                    var7 = class84.method2125(var4, -205103429);
                    if (var7.field3510 == -1 && var7.field3555 >= 0) {
                        class70.field1070[++field600 - 1] = var7.field3555;
                    } else {
                        class70.field1070[++field600 - 1] = var4;
                    }
                    ...
                    var5 = class70.field1070[--field600];
