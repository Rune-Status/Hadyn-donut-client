    ...
    static int method5037(int var0, class86 var1, boolean var2, byte var3) {
        if (var0 == 3600) {
            if (InboundPacketDescriptor.field2150.field1042 == 0) {
                ScriptExecutor.field1070[++class60.field600 - 1] = -2;
            } else if (InboundPacketDescriptor.field2150.field1042 == 1) {
                ScriptExecutor.field1070[++class60.field600 - 1] = -1;
            } else {
                ScriptExecutor.field1070[++class60.field600 - 1] = InboundPacketDescriptor.field2150.field1040
                    .method5586((byte) 1);
            }
            ...
            if (var0 == 3601) {
                ...
                if (InboundPacketDescriptor.field2150.method1751(-1806746806) && var4 >= 0
                    ...
                    ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = var9.method5548(-678646739);
                    ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = var9.method5544(-417976815);
                } else {
                ...
                String var6;
                if (var0 == 3604) {
                    var6 = ScriptExecutor.field1065[--ScriptExecutor.field1072];
                    ...
                    ScriptExecutor.field1070[++class60.field600 - 1] = InboundPacketDescriptor.field2150
                        .method1776(new class293(var6, client.field920), false, (byte) 3) ? 1 : 0;
                    return 1;
                } else if (var0 == 3611) {
                    if (class3.field26 != null) {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = class3.field26.field3726;
                    } else {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = "";
                    }
                    ...
                    if (class3.field26 != null) {
                        ScriptExecutor.field1070[++class60.field600 - 1] = class3.field26
                            .method5586((byte) 1);
                    } else {
                        ScriptExecutor.field1070[++class60.field600 - 1] = 0;
                    }
                    ...
                    if (class3.field26 != null && var4 < class3.field26.method5586((byte) 1)) {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = class3.field26
                    ...
                    var4 = ScriptExecutor.field1070[--class60.field600];
                    if (class3.field26 != null && var4 < class3.field26.method5586((byte) 1)) {
                        ScriptExecutor.field1070[++class60.field600 - 1] = ((class289) class3.field26
                    ...
                    if (!InboundPacketDescriptor.field2150.method1751(-1806746806)) {
                        ...
                        ScriptExecutor.field1070[++class60.field600 - 1] = InboundPacketDescriptor.field2150.field1041
                            .method5586((byte) 1);
                    }
                    ...
                    if (InboundPacketDescriptor.field2150.method1751(-1806746806) && var4 >= 0
                        ...
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = var5.method5548(-678646739);
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = var5.method5544(-1521421146);
                    } else {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = "";
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = "";
                    }
                    ...
                    if (class3.field26 != null && class3.field26.field3730 != null) {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = class3.field26.field3730;
                    } else {
                        ScriptExecutor.field1065[++ScriptExecutor.field1072 - 1] = "";
                    }
